...
$input	="INSERT INTO data_siswa (nim, nama_siswa, jk, foto, jurusan, tmp_lahir, tgl_lahir, alamat, nama_ibu, email, hp) VALUES ('$nim','$nama_siswa','$jk','$foto','$jurusan','$tmp_lahir','$tgl_lahir','$alamat','$nama_ibu','$email','$hp')";
